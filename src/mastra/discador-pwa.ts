...
// CACHE discador-v34: SW NETWORK-FIRST (online sempre pega a última versão;
...
// v34 popup de motivo tambem no reject (u23)
export const DISCADOR_SW_JS = `const CACHE='discador-v34';
